...
temas_cont = ["Receita c/ Direitos de Transmissão", "Receita c/ Transmissão + Premiações", "Receita c/ Publicidade e patrocínio", 
         ...
         "Receita Operacional Líquida", "Resultado", "EBITDA", "Dívida", "Despesas gerais e administrativas"]
...
#############################################################################################################################################
        ...
        fig.add_annotation(dict(font=dict(color="black", size=10), x=0.26, y=1.34, xanchor='left', showarrow=False, text='<b>GERAÇÃO DE<br>CAIXA TOTAL</b>'))
        fig.add_annotation(dict(font=dict(color="steelblue", size=10), x=0.285, y=1.24, showarrow=False, text=f'<b>{dfa.iat[7,0]}</b>'))
...
#############################################################################################################################################
        ...
        fig.add_annotation(dict(font=dict(color="limegreen", size=10), x=0.595, y=0.89, showarrow=False, text=f'<b>{dfa.iat[24,0]}</b>'))
...
#############################################################################################################################################
        ...
        # Node Colors
        color_for_nodes =['steelblue', 'steelblue', 'steelblue', 'steelblue', 'steelblue', 
                          'steelblue', 'blue', 'steelblue', 'maroon', 'blue', 'maroon', 
                          'maroon', 'maroon', 'maroon', 'maroon', 'maroon', 'maroon',
...
#############################################################################################################################################
        ...
        fig.add_annotation(dict(font=dict(color="black", size=10), x=0.77, y=0.65, xanchor='left', showarrow=False, text='<b>AUMENTO/<br>DIMINUIÇÃO DE CAIXA</b>'))
        fig.add_annotation(dict(font=dict(color="limegreen", size=10), x=0.85, y=0.57, showarrow=False, text=f'<b>{dfa.iat[21,0]}</b>'))
...
#############################################################################################################################################
        ...
        y = [-0.22, -0.00, 0.22, -0.05, 0.35,   0.65, 0.10, 0.18, 0.50, 0.65, 0.85, 0.35, -0.20, -0.10, -0.20, -0.25, -0.10]
        x = [.001 if v==0 else .999 if v==1 else v for v in x]
        y = [.001 if v==0 else .999 if v==1 else v for v in y]
...
#############################################################################################################################################
        ...
        # Set our X and Y co-ords 
        x = [0.15, 0.15, 0.15,   0.15, 0.30, 0.52, 0.65, 0.65, 0.65, 0.65,  0.45,   0.70,  0.70,  0.70,  0.37, 0.70, 0.70]
        y = [-0.22, -0.00, 0.22, 0.44, 0.10, 0.45, 0.45, 0.60,  0.75, 0.90, -0.00,   0.20, -0.00, -0.10, -0.17, 0.20, 0.10]
        x = [.001 if v==0 else .999 if v==1 else v for v in x]
        y = [.001 if v==0 else .999 if v==1 else v for v in y]
        ...
        fig.add_annotation(dict(font=dict(color="black", size=10), x=0.46, y=0.90, xanchor='left', showarrow=False, text='<b>SAÍDAS DE CAIXA<br>OPERACIONAIS</b>'))
        fig.add_annotation(dict(font=dict(color="indianred", size=10), x=0.52, y=0.80, showarrow=False, text=f'<b>{dfa.iat[8,0]}</b>'))
...
#############################################################################################################################################
        ...
        fig.add_annotation(dict(font=dict(color="black", size=10), x=0.80, y=0.75, xanchor='left', showarrow=False, text='<b>AUMENTO/<br>DIMINUIÇÃO DE CAIXA</b>'))
        fig.add_annotation(dict(font=dict(color="limegreen", size=10), x=0.88, y=0.62, showarrow=False, text=f'<b>{dfa.iat[21,0]}</b>'))
...
#############################################################################################################################################
        ...
        source =              [0, 1, 2, 3, 6,   7,  8,  8,   8,  8,  8,   8, 8,  16, 20, 21] #21 sources
        target =              [7, 7, 7, 7, 7,   8,  9, 10,  11, 12, 13,  14, 15, 15, 15, 15] #21 targets
        ...
        color_for_nodes =['steelblue', 'steelblue', 'steelblue', 'steelblue', 'steelblue', 
                          'steelblue', 'steelblue', 'steelblue', 'maroon', 'maroon', 'maroon', 
                          'maroon', 'maroon', 'maroon', 'maroon', 'limegreen', 'limegreen',
